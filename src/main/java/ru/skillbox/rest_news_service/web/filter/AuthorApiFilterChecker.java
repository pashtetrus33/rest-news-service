package ru.skillbox.rest_news_service.web.filter;
...
@Component
@ConditionalOnExpression("${app.check-author-api-header:true}")
public class AuthorApiFilterChecker extends OncePerRequestFilter {
    private static final String HTTP_CLIENT_HEADER = "X-Client-Api-Key";

    @Value("${app.author-api-key}")
